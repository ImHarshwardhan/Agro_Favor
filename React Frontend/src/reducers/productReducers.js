import {
  ...
  export const fetchProductReducer = (state = {}, action) => {
    switch (action.type) {
      ...
      case PRODUCT_FETCH_SUCCESS:
        return { loading: false, productresponse: action.payload }
  ...
  export const supplierFetchProductReducer = (state = {}, action) => {
    switch (action.type) {
  ...
  export const supplierFetchCurrentOrdersReducer = (state = {}, action) => {
    switch (action.type) {
